...
async def weight_loss(user_info: UserInfo):
    ...
    # Remember to replace the usage of e1, e2, e3, e4 with the variables age, veg, weight, height
    
    return {"message": "Success","BMI":bmi,"Recommendation":Food_itemsdata}  # You can return additional data if needed
...
async def healthy(user_info: UserInfo):
    ...
    print('\n Thank You for taking our recommendations. :)')
    return {"message": "Success","BMI":bmi,"Recommendation":Food_itemsdata}
